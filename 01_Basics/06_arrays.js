...
const myArr3 = [33, 12, 31, 46, 72, 55, 24];
const findElement = myArr3.find((element) => element > 10); //returns the first element in the provided array that satisfies the provided testing function.
console.log(findElement);

//filter method creates a shallow copy of a portion of a given array, filtered down to the condition
const filterArr = myArr3.filter((element) => element > 35);
console.log(filterArr);

//forEach method executes a provided function once for each array element.
myArr3.filter((element) => {
    if(element > 35)
        console.log(element);
});
